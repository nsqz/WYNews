...
- (void)configureUserInterface
{
    ...
    if (_mutableMenuItems.count > 0) {
        if ([_mutableMenuItems[_currentPageIndex] titleLabel] != nil) {
            ...
            [_mutableMenuItems[_currentPageIndex] titleLabel].font = [UIFont systemFontOfSize:19];
        }
    }
...
#warning 自己添加
                    [self.menuItems[self.lastPageIndex] titleLabel].font = [UIFont systemFontOfSize:16];
